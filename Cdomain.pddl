...
:effect (and (not (at_p2-2)) (at_p3-1) )
)
...
:effect (and (not (at_p2-2)) (at_p2-3) )
)
...
:effect (and (not (at_p2-2)) (at_p2-1) )
)
...
:effect (and (not (at_p3-2)) (at_p3-1) )
)
...
:effect (and (not (at_p1-1)) (at_p1-3) )
)
...
:effect (and (not (at_p3-2)) (at_p2-1) )
)
...
:effect (and (not (at_p3-2)) (at_p1-1) )
)
...
:effect (and (not (wumpus-at_p3-1)) (safe_p3-1) (wumpus-at_p3-1) )
)
